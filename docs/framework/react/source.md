...
`Lane`是一个`32bit Integer`，最高位为符号位，总共有31个不同的优先级，越低的位优先级越高。

| Lane | Priority | 说明 |
|:----:|:----------:|:----:|
| 0b0000000000000000000000000000010 | SyncLane | 最高优先级，同步执行 |
| b0000000000000000000000000001000 | InputContinuousLane | 用户输入的连续任务 |
| 0b0000000000000000000000000100000 | DefaultLane | 默认任务 |
| 0b0000000000000000000000001000000 | GestureLane | 手势任务 |
| 0b0000000000000000000000010000000 | TransitionLane | 过渡任务 |
| 0b0000000010000000000000000000000 | RetryLane | 重试任务 |
| 0b0000100000000000000000000000000 | SelectiveHydrationLane | 选择性Hydration任务 |
| 0b0010000000000000000000000000000 | IdleLane | 空闲任务 |
| 0b0100000000000000000000000000000 | OffscreenLane | 离屏任务 |
| 0b1000000000000000000000000000000 | DeferredLane | 非空闲任务 |
